...
if(VCPKG_TARGET_IS_IOS)
    # The iOS SDK can expose pipe2() even when the selected deployment target
    # cannot resolve it at runtime. Use curl's pipe()+fcntl() fallback instead.
...
set(inet_ntop_source "${SOURCE_PATH}/lib/curlx/inet_ntop.c")
if(NOT EXISTS "${inet_ntop_source}")
    set(inet_ntop_source "${SOURCE_PATH}/lib/inet_ntop.c")
endif()

file(READ "${inet_ntop_source}" inet_ntop_c)
